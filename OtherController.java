...
ShowService showService;
 ...
 public String regAdmin(@RequestParam String name,@RequestParam String username,
		 ...
		 @RequestParam String email,@RequestParam long mobno,
		 @RequestParam String address,@RequestParam long aadhar) {
	 
	 int s=registrationService.addAdmin(name,username,address,mobno,email,aadhar);
 ...
 public String regCust(@RequestParam String name,@RequestParam String username,@RequestParam String address,@RequestParam long mobno,@RequestParam String email,		 @RequestParam long aadhar) {
